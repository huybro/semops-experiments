...
class Model(str, Enum):
    ...
    VLLM_LLAMA3_1_8B = "hosted_vllm/meta-llama/Llama-3.1-8B-Instruct"
    # o1 = "o1-2024-12-17"
...
MODEL_CARDS = {
    ...
    Model.VLLM_LLAMA3_2_3B.value: LLAMA3_2_3B_INSTRUCT_MODEL_CARD,
    Model.VLLM_LLAMA3_1_8B.value: LLAMA3_1_8B_INSTRUCT_MODEL_CARD
}
