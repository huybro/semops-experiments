        ...
        "operations": [
            {
                "name": "filter_1_2",
                "type": "filter",
                "prompt": "{{ '' }}\n" + scenarios.FILTER_ENRON_FRAUD_2.strip(),
            ...
            },
            {
                "name": "filter_2_2",
                "type": "filter",
                "prompt": "{{ '' }}\n" + scenarios.FILTER_ENRON_NOT_NEWS_2.strip(),
                "output": {"schema": {"keep": "boolean"}},
                "model": model,
            },
            {
                "name": "map_2",
                "type": "map",
                "prompt": "{{ '' }}\n" + scenarios.MAP_ENRON_EXPLANATION_2.strip(),
            ...
            "steps": [
                {
                    "name": "step1",
                    "input": "enron",
                    "operations": ["filter_1_2", "filter_2_2", "map_2"],
                }
            ],
            "output": {
                "type": "file",
                "path": f"logs/{project}_enron_filter_filter_map_2.json",
            },
        },
    }
