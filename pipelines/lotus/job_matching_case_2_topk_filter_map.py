...
# Load Fever data
df_resume = load('/scratch/hojaeson_umass/kagglehub/snehaanbhawal/resume-dataset/versions/1/Resume/resume_txt', column='resume')
log = []
...
df = df_resume.sem_topk(scenarios.RESUME_CASE_2_TOPK, K=50)
print(len(df), df)
