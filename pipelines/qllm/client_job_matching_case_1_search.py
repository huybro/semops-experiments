...
if __name__ == "__main__":
    ...
    data_path = '/scratch/hojaeson_umass/kagglehub/snehaanbhawal/resume-dataset/versions/1/Resume/resume_txt_200'
    ...
    query_3 = (
        SemanticQueryBuilder(data_path, model_name=model_name)
        .sem_filter(scenarios.RESUME_CASE_3_FILTER)
        .sem_search(
            '/scratch/hojaeson_umass/kagglehub/kshitizregmi/jobs-and-job-description/versions/2/job_title_des_txt_50_ultra_selective',
            icp=True,
            icp_top_k=20,
        )
        .sem_map(scenarios.RESUME_CASE_3_MAP)
        # .sem_map(scenarios.RESUME_CASE_3_MAP)
        # # .sem_map(scenarios.RESUME_CASE_3_MAP)
        # .sem_filter(scenarios.RESUME_CASE_3_FILTER)
        # .sem_filter(scenarios.RESUME_CASE_3_FILTER)
