...
if __name__ == "__main__":
    ...
    query_builder = SemanticQueryBuilder(
        "/home/hojaeson_umass_edu/project/vllm-test/ref/lotus-experiment/data/fever_claims_evidence_3_5_tagged.csv",
        model_name=model_name,
    )

    query = (
        query_builder
            .sem_filter(scenarios.FEVER_FILTER)
            .sem_map(scenarios.FEVER_MAP)
    )
