...
df_resume = load(
    "/scratch/hojaeson_umass/kagglehub/snehaanbhawal/resume-dataset/versions/1/Resume/resume_txt_20",
    column="resume",
)
df_job = load(
    "/scratch/hojaeson_umass/kagglehub/kshitizregmi/jobs-and-job-description/versions/2/job_title_des_txt_20",
    column="job",
)
